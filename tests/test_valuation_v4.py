...
def test_manifest_requires_cycle_validator_audit_and_merge():
    ...
    assert set(stages['left_value_merge']['requires']) == {'left_value_fundamental', 'left_value_cycle', 'valuation_policy_audit'}
